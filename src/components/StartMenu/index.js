...
const StartMenu = ({ isOpen, onClose }) => {
	...
	return (
		<div className={styles.startMenu}>
			<div className={styles.menuItem}>Windows Update</div>
			<div className={styles.menuItem}>New Office Document</div>
			<div className={styles.menuItem}>Open Office Document</div>
