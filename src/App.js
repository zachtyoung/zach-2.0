      ...
      <div className={styles.desktop}>
        ...
        <nav className={styles.taskbar}>
          <div className={styles.startButton} onClick={toggleStartMenu}>
            <img className={styles.startIcon} src={start} alt="Start" />
            <span>Start</span>
            <StartMenu
          ...
          <div className={styles.systemTray}>
            <img src={world} alt="Connected" className={styles.speakerIcon} />
            <img src={battery} alt="battery" className={styles.speakerIcon} />
            <span>{batteryState.level * 100}%</span>
            <img src={speaker} alt="Speaker" className={styles.speakerIcon} />
